    ...
    function initSelectBoxYear(_year)
    {
        ...
        for (defaultYear; defaultYear <= _year; defaultYear++)
        {
            ...
            selYear.prepend(`<option ${selected} value="${defaultYear}">${defaultYear}년</option>`);
        }
    ...
    function buildSummary(data)
    {
        ...
        for (i; i<summaryData.text.length; i++)
        {
            ...
            let icon = txt.includes('회원') ? '<i class="fas fa-user"></i>' : '<img src="/assets/v1/images/icon_ucd_s.png" alt="아이콘">';
