	...
	import {lengthInput, btnSubmit, title, versionDigit, versionDecimal, dateFrom, dateTo, startTime, endTime} from '../modules/elements.js';
	import { sweetConfirm, sweetToast, sweetToastAndCallback } from  '../modules/alert.js';
	import {initInputDatepickerMinDateToday, setDateToday, limitInputLength} from "../modules/common.js";
	import {isEmpty, initInputNumberWithZero} from "../modules/utils.js";
	...
	function createRequest()
	{
		...
		const param = {
			...
			"target_version": `${versionDigit.val()}.${versionDecimal.val()}`,
