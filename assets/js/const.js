	...
	const message = {
		...
		,ajaxError: ' 처리 중, 일시적인 오류가 발생했습니다.<br>잠시 후 다시 시도해주세요.'
		,ajaxLoadError: '을 불러올 수 없습니다.<br>잠시 후 다시 시도해주세요.'
		...
		,overBalanceWithdraw: '보유 UCD가 출금 UCD보다 작은 사용자가 포함돼있습니다.<br>해당 사용자 삭제 후 다시 시도해주세요.'
		...
		,alreadyHasYellow: '이미 옐로카드를 받은 인증이 포함돼 있습니다.<br>해당 게시물 체크 해제 후 다시 시도해주세요.'
		,notEnoughBudget: '프로모션 예산이 부족해 두잇을 개설할 수 없습니다.<br>기업 또는 프로모션을 다시 선택해주세요.'
		,alreadyHasUser: '이미 추가된 회원이 포함돼 있습니다.<br>해당 회원을 체크 해제 후 다시 시도해주세요.'
